...
# **`Awesome`** Linux [Debuggers](https://wikipedia.org/wiki/Debugging) [![Awesome](https://awesome.re/badge.svg)](https://awesome.re)
</div>
...
[![YouTube](https://img.shields.io/badge/YouTube-%23FF0000.svg?style=for-the-badge&logo=YouTube&logoColor=white)](https://youtube.com/playlist?list=PLVXVzSlTiX-M&si=RvJwUnX7vkh_fpX4)
...
[GDB](https://wikipedia.org/wiki/GNU_Debugger), the GNU Project debugger, allows you to see what is going on `inside' another program while it executes -- or what another program was doing at the moment it crashed.
